  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center">
        <div className="flex-shrink-0 lg:w-1/2 flex flex-col items-start space-y-8 sm:space-y-10 pb-14 lg:pb-36 xl:pb-20 xl:pr-14 lg:mr-10 xl:mr-0">
          ...
          Energía | Luz | Humanidad |Transformación
          </span>
      ...
      <div className="z-10 mb-12 lg:mb-0 lg:-mt-20 xl:-mt-70 w-full">
        <HeroSearchForm />
      </div>
    </div>
  );
